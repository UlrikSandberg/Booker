...
<TableCell>{row.isVip.toString()}</TableCell>
<TableCell align="right">{row.something}</TableCell>
<TableCell>{row.customers.toString()}</TableCell>
<TableCell>{row.cinemaHall.toString()}</TableCell>
<TableCell>{row.somearray.join(", ")}</TableCell>
                                                <TableCell>
